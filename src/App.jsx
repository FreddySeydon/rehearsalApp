  ...
  const fetchSongs = async (albumId) => {
    ...
    try {
      ...
      songsList.forEach((song) =>
        lrcsList.push({ id: song.id, lrcs: song.lrcs })
      );
      setLrcs(lrcsList);
      fetchCurrentTracks();
      // fetchCurrentLrcs()
  ...
  const fetchCurrentLrcs = async () => {
    ...
    if (lrcs.length !== 0 && !loading) {
      ...
      if (currentLrcs?.length !== 0) {
        const currentLrcSourcesArray = await Promise.all(
          currentLrcs.map(async (lrc) => {
        ...
        {noAlbums ? (
          ...
          <div
            ...
            style={{
              ...
              paddingRight: isTabletOrMobile ? "1rem" : "0rem",
              paddingBottom: isTabletOrMobile ? "1rem" : "5rem",
              paddingTop: isTabletOrMobile ? "0rem" : "0rem",
              overflow: "hidden",
            }}
          >
            <div
              ...
              style={{
                ...
                gap: isTabletOrMobile ? 5 : 0,
                display: hideSelects ? "none" : "flex",
              }}
            >
              <div
                className="selectBox glasstransparent"
                style={{ padding: 10 }}
              >
            ...
            {isTabletOrMobile ? (
              ...
              >
                ...
                <button
                  ...
                  style={{ color: "white" }}
                >
                  {hideMixer ? "Show Mixer" : "Hide Mixer"}
                </button>
                <button
                  onClick={() => setHideSelects(!hideSelects)}
                  className="glassCard"
                  style={{ color: "white" }}
                >
                  {hideSelects ? "Show Selects" : "Hide Selects"}
                </button>
              </div>
            ) : null}
            {!blobsReady ? (
              ...
              >
                <div
                  className="controlsWrapper glasstransparent"
                  style={{
                    width: isTabletOrMobile ? "100%" : "50%",
                    order: isSwapped ? 2 : 1,
                    display: hideMixer ? "none" : "flex",
                    paddingBottom: 5,
                    justifyContent: "center",
                    alignItems: "center",
                  }}
                ...
                <div
                  className="lyricsWrapperr glasstransparent"
                  style={{
                    display: "flex",
                ...
                >
                  <div
                    style={{
                      ...
                      justifyContent: "center",
                      alignItems: "center",
                      marginTop: isTabletOrMobile ? 5 : 0,
                      padding: 10,
                    }}
                  >
                     ...
                     : noLrcs ? (
                      <div
                        style={{
                          ...
                          justifyContent: "center",
                          alignItems: "center",
                          marginLeft: isTabletOrMobile ? 0 : "0rem",
                        }}
                      >
                        <p style={{ fontSize: "1.25rem" }}>
                          No Lyrics for this song found
                        </p>
                        <Link
